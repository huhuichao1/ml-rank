 ...
 * IK词元对象 
 */
public class Lexeme2 implements Comparable<Lexeme2>{
	//lexemeType常量
	//未知
	...
	public Lexeme2(int offset , int begin , int length , int lexemeType){
		this.offset = offset;
		this.begin = begin;
		if(length < 0){
	...
	public boolean equals(Object o){
		...
		if(o instanceof Lexeme2){
			Lexeme2 other = (Lexeme2)o;
     ...
     */
	public int compareTo(Lexeme2 other) {
		//起始位置优先
	 ...
	 */
	public boolean append(Lexeme2 l , int lexemeType){
