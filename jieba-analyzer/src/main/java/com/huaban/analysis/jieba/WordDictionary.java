...
public class WordDictionary {
    ...
    private static final String STOP_DICT="/stopwords.txt"; 
    ...
    private void loadStopWords(){
          ...
          try {
              ...
              System.out.println(String.format(Locale.getDefault(), "stop word dict load finished, time elapsed %d ms",
    ...
    public void loadUserDict(InputStream is) {                
        try {
            ...
            System.out.println(String.format(Locale.getDefault(), "user dict %s load finished, tot words:%d, time elapsed:%dms", "", count, System.currentTimeMillis() - s));
            br.close();
        }
        catch (IOException e) {
            System.err.println(String.format(Locale.getDefault(), "%s: load user dict failure!"));
        }
    }
